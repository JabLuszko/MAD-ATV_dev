...
Flash [PoGoRom v1.4.1 A9 x64 S905W](https://github.com/ClawOfDead/ATVRoms/releases/tag/v1.4.1) like normally via USB Burning Tool (do not use any extra scripts/configurations/csv's) and before first boot put the USB thumbdrive/pendrive into the *other* USB PORT.
